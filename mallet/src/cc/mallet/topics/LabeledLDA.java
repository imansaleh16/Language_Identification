...
public class LabeledLDA implements Serializable {
	...
	public static void main (String[] args) throws Exception {
		...
		if(args[0].compareTo("train") == 0)
		{
	        ...
	        CommandOption.process (LabeledLDA.class, Arrays.copyOfRange(args, 1, args.length));
			...
			test("../lang_id/model_data/llda.model.ser", "../lang_id/data/docsME.llda.4grams");
	}
	...
	public static void test(String sModelFile, String sTestFile) throws IOException, ClassNotFoundException
	{
		...
		// parallel
		ois = new ObjectInputStream (new FileInputStream (sModelFile+".parallel"));
